...
public class ConfigurationPresetService implements ServicePlugin {
    ...
    public ConfigurationPreset updateConfigurationPreset(UpdateConfigurationPreset updateConfigurationPreset, SecurityContext securityContext) {
    ...
    public boolean updateConfigurationPresetNoMerge(CreateConfigurationPreset createConfigurationPreset, ConfigurationPreset configurationPreset) {
    ...
    public <T extends Baseclass> T getByIdOrNull(String id, Class<T> c, List<String> batchString, SecurityContext securityContext) {
        return configurationPresetRepository.getByIdOrNull(id, c, batchString, securityContext);
    }
    ...
    public PaginationResponse<ConfigurationPreset> getAllConfigurationPresets(ConfigurationPresetFiltering configurationPresetFiltering, SecurityContext securityContext) {
       ...
       return new PaginationResponse<>(list,configurationPresetFiltering,count);
    }
    ...
    public ConfigurationPreset createConfigurationPreset(CreateConfigurationPreset createConfigurationPreset, SecurityContext securityContext) {
    ...
    private ConfigurationPreset createConfigurationPresetNoMerge(CreateConfigurationPreset createConfigurationPreset, SecurityContext securityContext) {
        ConfigurationPreset configurationPreset = ConfigurationPreset.s().CreateUnchecked(createConfigurationPreset.getName(), securityContext);
        configurationPreset.Init();
        updateConfigurationPresetNoMerge(createConfigurationPreset, configurationPreset);
        return configurationPreset;
    }

    public void validate(CreateConfigurationPreset createConfigurationPreset, SecurityContext securityContext) {
