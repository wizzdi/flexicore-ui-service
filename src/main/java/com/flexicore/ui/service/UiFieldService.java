...
public class UiFieldService implements ServicePlugin {
	...
	public UiField createUiFieldNoMerge(UiFieldCreate createUiField,
			SecurityContext securityContext) {
		UiField uiField = UiField.s().CreateUnchecked(createUiField.getName(),
				securityContext);
		uiField.Init();
	...
	private PresetToRole createPresetToRoleNoMerge(
			PresetToRoleCreate presetToRoleCreate,
			SecurityContext securityContext) {
		PresetToRole presetToRole = PresetToRole.s().CreateUnchecked(
				"presetToRole", securityContext);
		presetToRole.Init(presetToRoleCreate.getPreset(),
				presetToRoleCreate.getRole());
	...
	private PresetToTenant createPresetToTenantNoMerge(
			PresetToTenantCreate presetToTenantCreate,
			SecurityContext securityContext) {
		PresetToTenant presetToTenant = PresetToTenant.s().CreateUnchecked(
				"presetToTenant", securityContext);
		presetToTenant.Init(presetToTenantCreate.getPreset(),
				presetToTenantCreate.getTenant());
	...
	private PresetToUser createPresetToUserNoMerge(
			PresetToUserCreate presetToUserCreate,
			SecurityContext securityContext) {
		PresetToUser presetToUser = PresetToUser.s().CreateUnchecked(
				"presetToUser", securityContext);
		presetToUser.Init(presetToUserCreate.getPreset(),
				presetToUserCreate.getUser());
