...
public class FormService implements ServicePlugin {
    ...
    public PaginationResponse<Form> getAllForms(FormFiltering formFiltering, SecurityContext securityContext) {
    ...
    public Form updateForm(FormUpdate updatePreset, SecurityContext securityContext) {
    ...
    public Form createForm(FormCreate createPreset, SecurityContext securityContext) {
    ...
    public Form createFormNoMerge(FormCreate createPreset, SecurityContext securityContext) {
        Form preset = Form.s().CreateUnchecked(createPreset.getName(), securityContext);
        preset.Init();
    ...
    public <T extends Baseclass> T getByIdOrNull(String id, Class<T> c, List<String> batchString, SecurityContext securityContext) {
        return formRepository.getByIdOrNull(id, c, batchString, securityContext);
    }
    ...
    public void validateCopy(FormCopy formCopy,SecurityContext securityContext){
        ...
        Form form=formId!=null?getByIdOrNull(formId,Form.class,null,securityContext):null;
        if(form==null){
