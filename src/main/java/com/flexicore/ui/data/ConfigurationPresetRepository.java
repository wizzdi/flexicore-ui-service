...
public class ConfigurationPresetRepository extends AbstractRepositoryPlugin {
	...
	public List<ConfigurationPreset> listAllConfigurationPresets(
		...
		CriteriaQuery<ConfigurationPreset> q = cb
				.createQuery(ConfigurationPreset.class);
		Root<ConfigurationPreset> r = q.from(ConfigurationPreset.class);
		List<Predicate> preds = new ArrayList<>();
		addConfigurationPresetPredicates(preds, cb, r,
				configurationPresetFiltering);
		QueryInformationHolder<ConfigurationPreset> queryInformationHolder = new QueryInformationHolder<>(
				configurationPresetFiltering, ConfigurationPreset.class,
				securityContext);
