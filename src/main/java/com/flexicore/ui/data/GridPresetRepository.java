...
public class GridPresetRepository extends AbstractRepositoryPlugin {
    ...
    public List<GridPreset> listAllGridPresets(GridPresetFiltering gridPresetFiltering, SecurityContext securityContext) {
        ...
        QueryInformationHolder<GridPreset> queryInformationHolder=new QueryInformationHolder<>(gridPresetFiltering,GridPreset.class,securityContext);
        return getAllFiltered(queryInformationHolder,preds,cb,q,r);
    }

    private void addGridPresetPredicates(List<Predicate> preds, CriteriaBuilder cb, Root<GridPreset> r, GridPresetFiltering gridPresetFiltering) {

    }

    public long countAllGridPresets(GridPresetFiltering gridPresetFiltering, SecurityContext securityContext) {
        CriteriaBuilder cb=em.getCriteriaBuilder();
