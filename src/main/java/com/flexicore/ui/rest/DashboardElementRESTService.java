...
public class DashboardElementRESTService implements RestServicePlugin {
	...
	public PaginationResponse<DashboardElement> getAllDashboardElements(
		...
		return service.getAllDashboardElements(dashboardElementFiltering,
				securityContext);
	...
	public DashboardElement updateDashboardElement(
			...
			@Context SecurityContext securityContext) {
		DashboardElement dashboardElementToClazz = updateDashboardElement
				.getId() != null ? service.getByIdOrNull(
				updateDashboardElement.getId(), DashboardElement.class, null,
				securityContext) : null;
		if (dashboardElementToClazz == null) {
			throw new BadRequestException("no ui field with id  "
					+ updateDashboardElement.getId());
		}
		updateDashboardElement.setDashboardElement(dashboardElementToClazz);

		return service.updateDashboardElement(updateDashboardElement,
				securityContext);
	...
	public DashboardElement createDashboardElement(
		...
		return service.createDashboardElement(createDashboardElement,
				securityContext);
