...
public class CreateDashboardExecution {
	...
	public <T extends CreateDashboardExecution> T setDescription(
			String description) {
	...
	public <T extends CreateDashboardExecution> T setDashboardElementId(
	...
	public <T extends CreateDashboardExecution> T setDashboardElement(
	...
	public <T extends CreateDashboardExecution> T setDynamicExecutionId(
	...
	public <T extends CreateDashboardExecution> T setDynamicExecution(
