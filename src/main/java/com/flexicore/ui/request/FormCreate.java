...
public class FormCreate extends CreatePreset {
    ...
    public <T extends FormCreate> T setDynamicExecutionId(String dynamicExecutionId) {
    ...
    public <T extends FormCreate> T setDynamicExecution(DynamicExecution dynamicExecution) {
