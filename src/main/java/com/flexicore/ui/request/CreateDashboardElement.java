...
public class CreateDashboardElement {
	...
	public <T extends CreateDashboardElement> T setDescription(
			String description) {
	...
	public <T extends CreateDashboardElement> T setDashboardId(
			String dashboardId) {
	...
	public <T extends CreateDashboardElement> T setContextString(
