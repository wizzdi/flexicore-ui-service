...
public class PresetToTenantCreate extends PresetToEntityCreate{
    ...
    public <T extends PresetToTenantCreate> T setPreferredTenantId(String preferredTenantId) {
    ...
    public <T extends PresetToTenantCreate> T setPreferredTenant(Tenant preferredTenant) {
